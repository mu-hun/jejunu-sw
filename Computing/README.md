...
[`4-week-report_cats.ipynb`](./4-week-report_cats.ipynb) 제출함.
...
[히어로즈 오브 더 스톰 : 시공의 폭풍](./strom_is_awsome) 애니매이션 제출함.
...
- [x] 아날로그 디지털 데이터
- [x] 문제와 문제 사례(서술)의 차이
  - 문제 사례 : 모든 상태 값이 구체적으로 명시가 되어 있음.
  - 문제 : 어떤 값으로 대체될 수 있는 하나 이상의 인자가 포함
- [x] 문제해결 프로그래밍, 시간복잡도
  - 문제해결 : 계산 활동을 컴퓨팅 기기에 위임하는 활동
  - 시간복잡도 : 입력된 n의 양에 비례한 연산의 수
- [x] 2진수의 보수
